...
void main() {
  ...
  group('HttpService test method', () {
    test("HttpService test GET", () async {
      ...
      final Response<dynamic> response = await service.get<dynamic>('/posts');
    ...
    test("HttpService test GET NOT FOUND URI", () async {
      ...
      final Response<dynamic> response = await service.get<dynamic>('/authors');
    ...
    test("HttpService test DELETE", () async {
      ...
      final Response<dynamic> response =
          await service.delete<dynamic>('/posts/1');
      expect(response.statusCode, 200);
    });
  });
}
